...
import com.kevin.newsapi.databinding.FragmentScienceBinding
...
class ScienceFragment : Fragment() {
    ...
    private fun NewsCall(page: Int) {
        ...
        api.getScience(ApiClient.country, category, ApiClient.apikey, ApiClient.page).enqueue(object :
            Callback<NewsModel> {
            override fun onResponse(call: Call<NewsModel>, response: Response<NewsModel>) {
                if (response.isSuccessful) {
                    ...
                    binding.rcvscience.adapter = adapter
                }
            }
